...
export default function ArqueoForm() {
  ...
  const handleEnviarArqueo = async () => {
    const success = await enviarArqueo();
    if (success) {
      resetEntregaSalida();
      resetCajaRollos();
      resetRaspas();
          ...
          {showScanner ? (
            ...
            <>
              <ThemedView style={styles.formContainer}>
                <ThemeInput placeholder="IP" value={formData.ip} />
                <ThemeInput placeholder="NOMBRE" value={formData.nombre} />
                <ThemeInput placeholder="CEDULA" value={formData.cedula} />
                <ThemeInput placeholder="SUCURSAL" value={formData.sucursal} />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={Total_ingreso} placeholder="Total Ingreso" />
                ...
                <ThemeInput value={Total_egresos} placeholder="Total Egresos" />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={Total_arqueo} placeholder="Total arqueo" />
                ...
                <ThemedText type="subtitle">
                  Caja Fuerte (Personal de turno de Venta)
                </ThemedText>
                <ThemeInput
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={Total_Rollos} placeholder="Total Rollos" />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={descargado} placeholder="Total Rollos" />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={descargado2} placeholder="Total Rollos" />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={descargado3} placeholder="Total Rollos" />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={descargado4} placeholder="Total Rollos" />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={descargado5} placeholder="Total Rollos" />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={descargado6} placeholder="Total Rollos" />
                ...
                <ThemeInput
                  ...
                  keyboardType="numeric"
                />
                <ThemeInput value={descargado7} placeholder="Total Rollos" />
