...
export const Entrega_salida = () => {
  ...
  const handleCalcular = () => {
    ...
    const total_ingresos =
      parseInt(Venta_bruta) + parseInt(Base_efectivo) + parseInt(Cartera);
    setTotal_ingreso(total_ingresos.toString());

    const total_egresos =
      parseInt(Chance_abonados) +
      parseInt(Chance_impresos) +
      parseInt(Premios_pagados) +
      parseInt(Efectivo_cajafuerte) +
      parseInt(Tirilla_recaudo);
